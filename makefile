...
ifeq ($(LAPACK), accelerate)
    ...
    LIBDIRFLAGS += -L$(CONDA_PREFIX)/5.0.0/aocc/lib -L$(CONDA_PREFIX)/5.0.0/aocc/lib_LP64 -L/usr/lib/gcc/x86_64-linux-gnu/11 -L$(CONDA_PREFIX)/lib
    LIBS +=  -lstdc++ -laoclutils -lblis-mt -lflame -lm -fopenmp
