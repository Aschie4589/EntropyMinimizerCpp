...
https://arxiv.org/pdf/1009.0437

Note: This library uses LAPACK (dgesvd, dgels) for numerical computations.
LAPACK interface is provided by lapack_interface.h which is decoupled from the project's common_includes.h
*/
...
namespace clebsch {
    ...
    public:
        ...
        weight(int N); // Note: indices of weight start with 1
    ...
    public:
        ...
        // Eq. (C7)
        pattern(const weight &irrep, int index = 0); // 0 based index again!
